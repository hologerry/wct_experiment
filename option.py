...
class Options:
    def __init__(self):
        ...
        train_arg.add_argument('--fine_size', type=int, default=512,
                               help='resize image to fine_size x fine_size,leave it to 0 if not resize')
        ...
        test_arg.add_argument('--fine_size', type=int, default=512,
                              help='resize image to fine_size x fine_size,leave it to 0 if not resize')
        test_arg.add_argument('--cuda', type=int, default=1, help='enables cuda')
        test_arg.add_argument('--gpu', type=int, default=0, help='gpu id')
        test_arg.add_argument('--vgg1', default='models/vgg_normalised_conv1_1.t7',
                              help='Path to the VGG conv1_1')
        test_arg.add_argument('--vgg2', default='models/vgg_normalised_conv2_1.t7',
                              help='Path to the VGG conv2_1')
        test_arg.add_argument('--vgg3', default='models/vgg_normalised_conv3_1.t7',
                              help='Path to the VGG conv3_1')
        test_arg.add_argument('--vgg4', default='models/vgg_normalised_conv4_1.t7',
                              help='Path to the VGG conv4_1')
        test_arg.add_argument('--vgg5', default='models/vgg_normalised_conv5_1.t7',
                              help='Path to the VGG conv5_1')
        test_arg.add_argument('--decoder5', default='models/feature_invertor_conv5_1.t7',
                              help='Path to the decoder5')
        test_arg.add_argument('--decoder4', default='models/feature_invertor_conv4_1.t7',
                              help='Path to the decoder4')
        test_arg.add_argument('--decoder3', default='models/feature_invertor_conv3_1.t7',
                              help='Path to the decoder3')
        test_arg.add_argument('--decoder2', default='models/feature_invertor_conv2_1.t7',
                              help='Path to the decoder2')
        test_arg.add_argument('--decoder1', default='models/feature_invertor_conv1_1.t7',
                              help='Path to the decoder1')
